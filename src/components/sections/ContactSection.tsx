...
export default function ContactSection({ settings, waLink }: ContactSectionProps) {
  return (
    <section id="contact" className="section" aria-labelledby="contactHeading">
      <div className="container">
        ...
        <p className="section-desc" style={{ marginBottom: '36px' }}>
          Tell us about the problem you need to solve. We&apos;ll respond honestly about fit.
        </p>
